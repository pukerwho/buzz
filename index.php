  ...
  <div class="flex flex-wrap lg:-mx-4 mb-8">
    ...
    <div class="w-full lg:w-1/4 lg:px-4 mb-8">
      <div class="rounded-lg shadow-lg">
        ...
        <div class="bg-white rounded-b-lg p-3">
          <div class="border-b border-gray-200 last-of-type:border-transparent mb-2 last-of-type:mb-0 pb-2 last-of-type:pb-0"><a href="https://armadio.net.ua/" class="text-gray-700 hover:text-blue-500">armadio.net.ua</a></div>
